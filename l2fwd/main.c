...
static uint64_t last_packets_tx, last_packets_rx;
...
print_stats(uint64_t timer_tsc)
{
	...
	double elapsed_sec = (double)timer_tsc / rte_get_timer_hz();
	avg_tx_pps = (total_packets_tx - last_packets_tx) / elapsed_sec;
	avg_rx_pps = (total_packets_rx - last_packets_rx) / elapsed_sec;
	
	last_packets_tx = total_packets_tx;
	last_packets_rx = total_packets_rx;
	...
	printf("\n pps statistics ===================================="
		   "\n avg avg_tx_pps: %18.2f"
		   "\n avg avg_rx_pps: %18.2f",
		   avg_tx_pps,
		   avg_rx_pps);	   
	printf("\n====================================================\n");
